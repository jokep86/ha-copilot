...
class AutomationsModule(ModuleBase):
    """Automation CRUD via Claude-generated YAML. Stub — full implementation in Phase 4."""
    ...
    async def handle_command(
        ...
        logger.info("automations_stub_called", cmd=cmd, user_id=context.user_id)
