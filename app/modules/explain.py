"""
AI documentation for entities and automations — Phase 4 stub.
"""
...
class ExplainModule(ModuleBase):
    """AI natural language documentation for automations, entities, and integrations. Stub — full implementation in Phase 4."""
    ...
    async def handle_command(
        ...
        logger.info("explain_stub_called", cmd=cmd, user_id=context.user_id)
