"""
Direct HA API calls for power users — Phase 3 stub.
"""
...
class RawApiModule(ModuleBase):
    """Direct HA REST and Supervisor API calls with formatted JSON responses. Stub — full implementation in Phase 3."""
    ...
    async def handle_command(
        ...
        logger.info("raw_api_stub_called", cmd=cmd, user_id=context.user_id)
