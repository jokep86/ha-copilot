"""
Add-ons, backups, restarts, and resource monitoring — Phase 3 stub.
"""
...
class SupervisorManagerModule(ModuleBase):
    """Add-on CRUD, backups, restarts, and resource monitoring via Supervisor API. Stub — full implementation in Phase 3."""
    ...
    async def handle_command(
        ...
        logger.info("supervisor_mgr_stub_called", cmd=cmd, user_id=context.user_id)
